...
export const ProductManagement = () => {
  ...
  return (
    <>
      {actionError && (
        <div className="mb-6 text-sm text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-900/20 p-4 rounded-xl border border-red-200 dark:border-red-900/50 flex justify-between items-center">
      ...
      {isAdding && (
        <div className="mb-8 bg-white/80 dark:bg-slate-800/40 backdrop-blur-md border border-slate-200 dark:border-slate-700/50 shadow-xl dark:shadow-2xl sm:rounded-2xl overflow-hidden">
          <div className="px-6 py-6 sm:p-8">
            <h3 className="text-lg leading-6 font-semibold text-slate-900 dark:text-slate-100 mb-6">Add a New Product</h3>
            ...
            <form onSubmit={handleAdd} className="space-y-6">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-1 flex items-center gap-4">
                    <div className="relative group">
                      <div className="h-24 w-24 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-600/50 bg-slate-50 dark:bg-slate-900/50 flex flex-col items-center justify-center overflow-hidden transition-all group-hover:border-primary/50">
                        {isUploadingImage ? (
                    ...
                    <div className="text-sm text-slate-500 dark:text-slate-400">
                      <p className="font-medium text-slate-700 dark:text-slate-300">Upload Image</p>
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Category ID</label>
